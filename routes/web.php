...
Route::get('/sms-api-check', 'Frontend\FrontendController@smsApiCheck');
Route::get('/prescription/download/pdf/{id}', 'Frontend\FrontendController@prescriptionDownload')->name('prescriptionDownload');
Route::get('/telemedicine/invoice/download/pdf/{id}', 'Frontend\FrontendController@invoiceDownload')->name('invoiceDownload');
Route::get('/about-us', 'Frontend\AboutController@About')->name('about.us');
Route::get('/faq', 'Frontend\AboutController@faq')->name('about.faq');
Route::get('/contact', 'Frontend\AboutController@contact')->name('contact');
Route::get('/paymentTerms', 'Frontend\AboutController@paymentTerms')->name('paymentTerms');
Route::get('/termsAndCondition', 'Frontend\AboutController@termsAndCondition')->name('termsAndCondition');
Route::get('/privacy', 'Frontend\AboutController@privacy')->name('privacy');
...
//
Route::get('/doctoc-details/{title}', 'Frontend\FrontendController@details')->name('doctor-details');
