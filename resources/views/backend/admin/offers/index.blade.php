                            ...
                            @foreach($offers as $key => $offer)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group col-md-2 m-0 pt-2">
                                            <label class="switch">
                                                ...
                                                <input onchange="update_published(this)" value="{{ $offer->id }}" {{$offer->is_publish == 1 ? 'checked':''}} type="checkbox" >
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info waves-effect" href="{{route('admin.offers.show',$offer->id)}}">
                                            <i class="fa fa-eye"></i>
                                        </a>
