...
@section("title","TelemedicineRequest Review List")
@push('css')
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Telemedicine Review List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Telemedicine Review List</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <select name="rating" id="" class="form-control select2">
                                                ...
                                                <option value="3.5" {{$value == 3.5 ? 'selected' : ''}}>3.5</option>
                                                <option value="3" {{$value == 3 ? 'selected' : ''}}>3</option>
                                                <option value="2.5" {{$value == 2.5 ? 'selected' : ''}}>2.5</option>
                                                <option value="2" {{$value == 2 ? 'selected' : ''}}>2</option>
                                                <option value="1.5" {{$value == 1.5 ? 'selected' : ''}}>1.5</option>
...
{{--                                        @dd($review->user->name)--}}
                                        ...
                                        <td>{{$review->SpecialistDr->user->name}}</td>
                                        <td>{{$review->rating}}</td>
                                        <td>
