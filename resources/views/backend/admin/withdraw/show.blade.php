                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="#">  <input type="test" readonly  value="{{$delivery_man_show_request->user_name}}" class="form-control" id="inputName"></a>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail" class="col-sm-2 col-form-label">Phone</label>
                                    <div class="col-sm-10">
                                        <a href="#">    <input type="text" readonly   value="{{$delivery_man_show_request->user_phone}}" class="form-control" id="inputEmail"></a>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                        <b>Delivery Charge</b>: <a href="#"> {{$delivery_man_show_request->delivery_charge}}</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Delivery Man Charge </b> :<a href="#">  {{$delivery_man_show_request->delivery_man_cost}}</a>
                                    </li>
                        ...
                        <div class="card card-outline">
                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b style="font-size: 20px;color:#e72228">E-prescription</b> :<a href="#" target="_blank" style="font-size: 20px"> Download</a>
                                    </li>
                                    <li class="list-group-item" >
                                        <b style="font-size: 20px;color:#e72228">Prescription Image </b> :<a href="{{asset('frontend/p.jpg')}}" target="_blank" style="font-size: 20px">
                                           Image</a>
                                    </li>
